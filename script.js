document.addEventListener('DOMContentLoaded', () => {
    ...
    function validateConfigAndProceed() {
        // Jika input kosong, anggap nilainya "0".
        ...
        // Pengecekan isNaN masih berguna jika pengguna mengetik teks (misal: "abc")
        if (isNaN(total) || isNaN(civ) || isNaN(uc) || isNaN(mw)) { 
            showConfigError("Field hanya boleh diisi dengan angka."); 
            return; 
        }
        if (total < 3) { 
