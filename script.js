document.addEventListener('DOMContentLoaded', () => {
    ...
    function resetGameFull() {
        document.body.classList.add('state-config'); // TAMBAHKAN KELAS UNTUK GAYA MENU UTAMA
        ...
        if (backgroundMusic.src) {
             backgroundMusic.src = backgroundMusicTracks[0];
        }
        ...
        const screensToHide = [playerNameInputSection, cardRevealModal, gameSection, winnerPopupModal, roundOverSection, finalScoreDisplayModal, eliminationResultPopup, mrWhiteGuessSection, massPenaltyModal, musicSettingsModal, peekPlayerSelectModal, howToPlayModal];
    ...
    function validateConfigAndProceed() {
        ...
        document.body.classList.remove('state-config'); // HAPUS KELAS GAYA MENU UTAMA SAAT LANJUT
        resumeAudioContext();
