document.addEventListener('DOMContentLoaded', () => {
    ...
    // (Tidak ada perubahan signifikan di sini, hanya memanggil fungsi suara yang baru)
    ...
    // --- SISA FUNGSI GAME (TIDAK ADA PERUBAHAN) ---
    // (Semua fungsi logika game di bawah ini tetap sama persis)
