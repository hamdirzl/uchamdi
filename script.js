document.addEventListener('DOMContentLoaded', () => {
    ...
    // === LOGIKA KONTEN KARTU DINAMIS DIKEMBALIKAN ===
    revealRoleCardButton.addEventListener('click', () => {
        ...
        // Logika asli untuk menentukan txt dikembalikan
        ...
        // console.log("Mobile Test - Card content set to:", txt); // Dihapus/dikomentari
    ...
    checkMyWordAgainButton.addEventListener('click', () => {
        ...
        if (name) {
            ...
            if (p) {
                ...
                // console.log("Mobile Test - Check word content set to:", txt); // Dihapus/dikomentari
    ...
    // === AKHIR PENGEMBALIAN LOGIKA KONTEN KARTU ===
