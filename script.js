document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupAudioFiles() {
        ...
        try {
            ...
            // Secara eksplisit panggil .load() untuk memberi tahu browser agar mulai mengambil data audio.
            // Ini sangat membantu di Safari Mobile.
            clickSound.load();
            loseSound.load();
            winSound.load();
            ...
            if (backgroundMusic) {
                ...
                backgroundMusic.load(); // Muat juga musik latar
            }
