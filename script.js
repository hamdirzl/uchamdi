document.addEventListener('DOMContentLoaded', () => {
    ...
    // const roundScoringSection = document.getElementById('round-scoring-section'); // Dihilangkan karena skor digabung
    ...
    // const roundPlayerScoresListUl = document.getElementById('round-player-scores-list'); // Dihilangkan
    ...
    function resetGameFull() {
        ...
        // if (roundPlayerScoresListUl) roundPlayerScoresListUl.innerHTML = ''; // Sudah tidak ada
    ...
    function displayRoundOverDetails() {
        calculateAndDisplayRoundScores(); // Skor dihitung dan langsung digunakan di roundRolesListUl
        roundOverTitleH2.textContent = "🏁 Babak Selesai! 🏁"; 
        roundRolesListUl.innerHTML = ''; // Kosongkan list sebelum diisi lagi
        ...
        players.forEach(p => { 
            ...
            // Ambil skor yang sudah dihitung untuk pemain ini
            const roundScoreForPlayer = p.roundScoreThisTurn || 0; // roundScoreThisTurn ditambahkan saat kalkulasi skor
        ...
        // if (roundScoringSection) roundScoringSection.classList.add('hidden'); // Sembunyikan section skor terpisah
        
        truthOrDareSection.classList.add('hidden'); 
    }

    function calculateAndDisplayRoundScores() {
        // Fungsi ini sekarang hanya menghitung skor dan menyimpannya di objek player
        // Tampilan skor akan digabungkan di displayRoundOverDetails
        players.forEach(player => {
            ...
            player.roundScoreThisTurn = roundScore; // Simpan skor babak ini untuk ditampilkan
        });
    }
